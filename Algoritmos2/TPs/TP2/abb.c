...
static nodo_t* crear_nodo(const char* clave, void* dato){
...
bool _abb_in_order_ascendente(nodo_t* actual, bool visitar(void *, void *), void *extra, abb_comparar_clave_t comparar_clave, char* desde, char* hasta){
  ...
  if (comparar_clave(actual->clave, desde)>=0) {
    if (!_abb_in_order_ascendente(actual->izquierda, visitar, extra, comparar_clave, desde, hasta)) {
      return false;
    }
  }


  if ((comparar_clave(actual->clave, hasta) <= 0)&&(comparar_clave(actual->clave, desde) >= 0)) {
  ...
  if (comparar_clave(actual->clave, hasta)<=0) {
    if (!_abb_in_order_ascendente(actual->derecha, visitar, extra, comparar_clave, desde, hasta)) {
      return false;
    }
  }
...
bool _abb_in_order_descendente(nodo_t* actual, bool visitar(void *, void *), void *extra, abb_comparar_clave_t comparar_clave, char* desde, char* hasta){
  ...
  if (!actual) {
	...
	if (comparar_clave(actual->clave, hasta) <= 0) {
    if (!_abb_in_order_descendente(actual->derecha, visitar, extra, comparar_clave, desde, hasta)) {
      return false;
    }
	}

	if ((comparar_clave(actual->clave, desde) >= 0) && (comparar_clave(actual->clave, hasta) <= 0)) {
		if (!visitar(actual->dato, extra)) {
			return false;
		}
	}
  ...
  if (comparar_clave(actual->clave, desde) >= 0) {
    if (!_abb_in_order_descendente(actual->izquierda, visitar, extra, comparar_clave, desde, hasta)) {
      return false;
    }
  }
...
void abb_in_order(abb_t *arbol, bool visitar(void *, void *), void *extra, char* desde, char* hasta, char* orden){
  ...
  if (!strcmp(orden, RECORRIDO_DESCENDENTE)) {
    _abb_in_order_descendente(arbol->raiz, visitar, extra, arbol->comparar_clave, desde, hasta);
  }else{
    _abb_in_order_ascendente(arbol->raiz, visitar, extra, arbol->comparar_clave, desde, hasta);
  }
